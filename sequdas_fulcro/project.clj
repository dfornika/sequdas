(defproject sequdas_fulcro "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "sequdas_fulcro.jar"
  ...
  :cljsbuild {:builds [{:id           "production"
                        ...
                        :compiler     {:asset-path    "js/prod"
                                       :main          sequdas_fulcro.client-main
                                       :optimizations :advanced
                                       :source-map    "resources/public/js/sequdas_fulcro.js.map"
                                       :output-dir    "resources/public/js/prod"
                                       :output-to     "resources/public/js/sequdas_fulcro.js"}}]}

  :profiles {:uberjar    {:main           sequdas_fulcro.server-main
                          :aot            :all
                          ...
                          :cljsbuild    {:builds
                                         [{:id           "dev"
                                          ...
                                          {:id           "test"
                                           ...
                                           :figwheel     {:on-jsload "sequdas_fulcro.client-test-main/client-tests"}
                                           :compiler     {:asset-path    "js/test"
                                                          :main          sequdas_fulcro.client-test-main
                                                          :optimizations :none
